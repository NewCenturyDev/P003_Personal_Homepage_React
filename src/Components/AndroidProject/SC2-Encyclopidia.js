                ...
                <Grid columns={1} style={{maxWidth: 1200, margin: '0 auto', fontSize: 16, lineHeight: 1.5}}>
                    ...
                    <Grid.Column className='grid_block'>
                        ...
                        <p style={{margin: '0 25px'}}>
                            <li><b>아직 구상중인 프로젝트인 관계로 어떠한 기술을 사용하여 구현할지는 고민하고 있습니다.</b></li>
                            <li>안드로이드 App 형태로는 필히 개발할 생각입니다.(Class 구조도 및 FlowChart 설계 중)</li>
                            <li>Modern Web FrameWork를 통해 제작한 웹 App과 연동하여 Hybrid 형태로 갈 지, 웹서비스 없이 순수 Android 어플리케이션 형태의 Native로 갈 지 고민중입니다.</li>
                        </p>
                        <h3>Frontend</h3>
                        <ul>
                    ...
                    <Grid.Column className='grid_block'>
                        ...
                        <h3>구현 내용 개요</h3>
                        <p style={{margin: '0 25px'}}>
                        <b>Starcraft1, Starcraft2를 주제로 한 "롤백과사전" 류 어플리케이션</b>
                        </p>
                        <h3>구현 완료 기능</h3>
                        <p style={{margin: '0 25px'}}>
                        <b>계획중인 프로젝트입니다. (FlowChart, Class 구조도 설계 중)</b>
                        </p>
                        <h3>최종 개발 목표</h3>
                        <p style={{margin: '0 25px'}}>
                    ...
                    <Grid.Column className='grid_block'>
                        ...
                        이에 Starcraft 시리즈의 팬으로써 여러 기능이 지원되는 공략집 및 백과사전 어플을 만들어보려고 합니다.<br/>
                        </p>
                    </Grid.Column>
                    <Grid.Column className='grid_block'>
                        <h2>프로젝트 스크린-샷</h2>
