            ...
            <div style={{width: 'calc(100%-300px)',backgroundColor: 'rgba(0,0,0,0.05)'}}>
                <Grid columns={1} style={{maxWidth: 1200, margin: '0 auto', fontSize: 16, lineHeight: 1.5}}>
                    ...
                    <Grid.Column className='grid_block'>
                        ...
                        <h3>개요</h3>
                        <p style={{margin: '0 25px'}}>
                            요즘 웹 프로그래밍 분야에서 핫한 React.js를 사용하여 Single Page Application 형태로 개발하였습니다.<br/>
                            또한, 디자이너와 협업하지 않고도 시대에 매우 뒤떨어지고 난잡했던 기존 웹 페이지의 디자인에서 탈피하여,
                            미려하고 세련된 디자인을 적용할 수 있도록 디자인 라이브러리를 사용하였습니다.
                        </p>
                        <h3>Frontend</h3>
                        <ul>
